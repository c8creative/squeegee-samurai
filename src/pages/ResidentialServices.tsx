  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Home className="w-16 h-16 mx-auto mb-6 text-blue-200" />
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Complete Home Window Care</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Interior & Exterior Cleaning</h4>
                    <p className="text-gray-600">Complete cleaning of both sides of your windows for maximum clarity and brightness.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Screen Cleaning & Maintenance</h4>
                    <p className="text-gray-600">Thorough cleaning of window screens to improve airflow and extend their lifespan.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Sill & Frame Cleaning</h4>
                    <p className="text-gray-600">Detailed cleaning of window sills, frames, and tracks to remove dirt and debris.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Spot & Stain Removal</h4>
                    <p className="text-gray-600">Specialized treatment for hard water spots, paint, and other stubborn stains.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Post-Service Inspection</h4>
                    <p className="text-gray-600">Quality assurance check to ensure every window meets our high standards.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg">
              <h3 className="text-2xl font-semibold text-blue-900 mb-6">Service Packages</h3>
              
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="text-xl font-semibold mb-2">Basic Package</h4>
                  <p className="text-gray-600 mb-4">Exterior window cleaning only</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border-2 border-green-500">
                  ...
                  <p className="text-gray-600 mb-4">Interior and exterior cleaning</p>
                  <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600 mb-4">Complete service plus extras</p>
                  <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Service Frequency Options</h2>
            <p className="text-lg text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600 mb-4">Perfect for special occasions, move-ins, or seasonal cleaning</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center border-2 border-green-500">
              ...
              <p className="text-gray-600 mb-4">Scheduled cleaning to keep your windows consistently clean</p>
              <ul className="text-sm text-gray-600 space-y-2">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600 mb-4">Spring and fall cleaning to maintain your home's appearance</p>
              <ul className="text-sm text-gray-600 space-y-2">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Homeowners Choose Us</h2>
            <p className="text-lg text-gray-600">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">Small home (10-15 windows)</span>
                    <span className="font-semibold">$80-120</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">Medium home (16-25 windows)</span>
                    <span className="font-semibold">$120-180</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">Large home (26-40 windows)</span>
                    <span className="font-semibold">$180-280</span>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-700">Extra large home (40+ windows)</span>
